...
namespace HELMA20250404.AppMVCCore.Controllers
{
    ...
    public class AulasController : Controller
    {
        ...
        public AulasController(SistemaCalificacionesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Aula aula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Aula aula)
        {
            if (id != aula.Id)
            {
                return NotFound();
